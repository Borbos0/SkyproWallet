const Expenses = () => (
  ...
  <div className="expenses-table__header">
    <div className="expenses-table__line expenses-table__line--first flex ml-8">
      <h2 className="expenses-table__title text-black font-montserrat text-2xl font-bold leading-[29px] tracking-normal text-center">Таблица расходов</h2>
      <div className="expenses-table__filters flex">
        <div className="expenses-table__filter text-[12px]">Фильтровать по категории</div>
        <div className="expenses-table__filter text-[12px]">Сортировать по дате</div>
      </div>
    </div>
